...
function add_copyright () {
  ...
  function setClipboardText (event) {
    ...
    var htmlData = window.getSelection().toString().replace(/\r\n/g, '<br>') + '\r\n' + '\r\n----------------------------------------------------\r\n' + mashiro_option.copyright_description + '<br>' + '作者：' + mashiro_option.author_name + '<br>' + '链接：' + window.location.href + '<br>' + '来源：' + mashiro_option.site_name + '<br><br>' 
    var textData = window.getSelection().toString().replace(/\r\n/g, '\n') + '\r\n' + '\r\n----------------------------------------------------\r\n' + mashiro_option.copyright_description + '\n' + '作者：' + mashiro_option.author_name + '\n' + '链接：' + window.location.href + '\n' + '来源：' + mashiro_option.site_name + '\n\n' 
